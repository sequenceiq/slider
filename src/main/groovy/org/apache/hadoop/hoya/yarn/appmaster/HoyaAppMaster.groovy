...
/* =================================================================== */
   ...
   * {@link #buildEnvMapFromServiceArguments()} 
...
*/
   ...
   * This map is intended to be valid on the AM and on any of the Containers
   * @return an env map to merge with the rest of the environment
   */
